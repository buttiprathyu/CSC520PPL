...
Env evaldef(Def d, Env env, Echo echo) {
    switch (d->alt) {
    case VAL:
        /* evaluate [[val]] binding and return new environment 169c */
        {
...
/* evaluate expression, store the result in [[it]], and return new environment 170a */
        {
    ...
    case DEFINE:
        /* evaluate function definition and return new environment 170b */
