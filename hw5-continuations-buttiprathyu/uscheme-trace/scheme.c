...
/* scheme.c S154b */
extern Printer printvalue1, printvaluelist1, printindent;
extern Name tracename;
...
int main(int argc, char *argv[]) {
    ...
    installprinter('V', printvaluelist);
     installprinter('w', printvalue1);
     installprinter('W', printvaluelist1);

    installprinter('%', printpercent);
     installprinter('i', printindent);
    ...
    /* install predefined functions into [[env]] S155b */
     env = bindalloc(tracename = strtoname("&trace"), mkNum(0), env);
...
";  definitions of predefined uScheme functions [[and]], [[or]], and [[not]] 160a \n"
...
";  predefined uScheme functions (BUG: software can't tell where this code came from [NW2Nhgep-1VrCoa-5]) \n"
